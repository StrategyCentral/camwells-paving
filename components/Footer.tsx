  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-white font-black text-lg mb-3">CAM WELLS <span className="text-purple-500">PAVING</span></h3>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            <li><Link href="/driveway-paving-melbourne/" className="hover:text-purple-400 transition-colors">Driveway Paving Melbourne</Link></li>
            <li><Link href="/brick-paving-melbourne/" className="hover:text-purple-400 transition-colors">Brick Paving Melbourne</Link></li>
            <li><Link href="/exposed-aggregate-concrete-driveways-melbourne/" className="hover:text-purple-400 transition-colors">Exposed Aggregate Concrete Driveways</Link></li>
            <li><Link href="/concrete-driveways-melbourne/" className="hover:text-purple-400 transition-colors">Concrete Driveways Melbourne</Link></li>
            <li><Link href="/exposed-aggregate-concreters/" className="hover:text-purple-400 transition-colors">Exposed Aggregate Concreters</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-white font-bold mb-3">Contact Us</h4>
          <p className="text-sm mb-2">Melbourne, Bayside &amp; Mornington Peninsula</p>
          <a href="tel:0407334139" className="text-purple-400 font-bold text-lg hover:text-purple-300">0407 334 139</a>
